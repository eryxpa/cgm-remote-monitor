...
function init() {
  ...
  var translations = {
    ...
    ,'Store hash on this computer (Use only on private computers)' : {
      ...
      ,dk: 'Gemme hashværdi på denne computer (brug kun på privat computer)'
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,es: 'Su dispositivo aún no está autenticado'
    ...
    ,'Reset, and use defaults' : {
      ...
      ,es: 'Resetear y utilizar los valores por defecto'
   ...
   ,'Last Carbs' : {
    ...
    ,'Insulin reservoir change overdue!' : {
      ...
      ,es: 'Cambio de reservorio vencido!'
    ...
    ,'Change insulin reservoir soon' : {
      ...
      ,es: 'Cambiar reservorio en breve'
